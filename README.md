...
- **书城**：浏览书城推荐、搜索书籍
- **全书后台下载**：一次后台下载一本书并打包成单个 EPUB，封面显示章节进度，长按可取消
- **划线与书友想法**：下载书籍时可选“仅下载正文”或“正文及评论”；选择评论会预下载划线和书友想法，点击下划线时优先读取缓存，并支持继续「加载更多」
...
- **后台进度**：开始下载后可继续浏览书架，当前书籍封面显示下载百分比；同一时间只下载一本，长按正在下载的书可取消
- **划线评论**：下载确认框可选择是否包含评论；选择“正文及评论”会分批预下载划线和评论，选择“仅下载正文”则不发起这些额外请求。点击橙色下划线可打开「书友想法」，未缓存的范围及更多评论仍会按需加载
...
luajit spec/test_desktop_store_hold.lua
